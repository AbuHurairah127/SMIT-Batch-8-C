...
function printCustomValue(str1) {
    console.log(str1);
}
...
// names("Ali", "Ahmad");
// Optional Parameters
function names2(firstName, lastName, middleName) {
    //parameter
    if (middleName) {
...
function names(lastName, firstName = "Muhammad") {
    console.log(firstName, lastName);
}
...
arrowFunction();
const sum = (_num1, _num2) => _num1 + _num2; // Lambda Functions
